...
ggplot(cnt, aes(x=cnt))+
  ...
  ggtitle("Stress Scores for Patients at risk of Obstetric Disease with Private Insurance") +
  geom_density(aes(y = ..density..*40),lwd = 2, col = "black", adjust = 1) +
  xlab("Count") + ylab("Percentage")
```
